...
#用户预测图片集
PDataPicPath = [
    ['Upic/up1/up_0_10.jpg', 'Upic/up1/up_0_20.jpg', 'Upic/up1/up_0_30.jpg', 'Upic/up1/up_0_60.jpg', 'Upic/up1/up_0.jpg'],
    ['Upic/up2/up_1_10.jpg', 'Upic/up2/up_1_20.jpg', 'Upic/up2/up_1_30.jpg', 'Upic/up2/up_1_60.jpg', 'Upic/up2/up_1.jpg'],
    ['Upic/up3/up_2_10.jpg', 'Upic/up3/up_2_20.jpg', 'Upic/up3/up_2_30.jpg', 'Upic/up3/up_2_60.jpg', 'Upic/up3/up_2.jpg'],
]
########################################################################
...
class Demo(wx.Frame):
    def __init__(self):
        ...
        f = wx.Font(15, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL ,False,face=u"华文新魏")
        ...
        #self.Panel2.Bind(wx.EVT_ERASE_BACKGROUND, self.OnEraseBackgroundPane2)
        #***************panel 1******功能模块面板内含信息初始化****************************************
        IndexSystemButton = wx.Button(self.Panel1, label=u'       新型KPI分析      ')
        ...
        self.indexRegion = wx.StaticText(self.Panel2, -1, u"指标小区选择:", style=wx.ALIGN_CENTER)
        self.sampleList_IR = [u"华科部分小区"]
        self.choices_IR = wx.Choice(self.Panel2, -1, choices=self.sampleList_IR, style=wx.ALIGN_CENTER)
        ...
        self.MSelectUserRegionButton.Bind(wx.EVT_BUTTON, self.MselectUserRegion)
        ...
        self.times2 = wx.StaticText(self.Panel2, -1, u"预测时间:", style=wx.ALIGN_CENTER)
        ...
        self.CSTbox.Add(CaseOneButton, proportion=0, flag=wx.LEFT |wx.TOP , border=25)
        self.CSTbox.Add(CaseTwoButton, proportion=0, flag=wx.LEFT |wx.TOP, border=25)
        self.CSTbox.Add(CaseThreeButton, proportion=0, flag=wx.LEFT |wx.TOP, border=25)

        self.ISBbox = wx.BoxSizer(wx.VERTICAL)
        self.ISBbox.Add(IndexSystemButton, proportion=0, flag=wx.TOP, border=25)

        self.BDAbox = wx.BoxSizer(wx.VERTICAL)
        self.BDAbox.Add(BigDataAnalysisButton, proportion=0, flag=wx.TOP, border=50)

        self.CSSbox = wx.BoxSizer()
        self.CSSbox.Add(CaseShowButton, proportion=0, flag=wx.TOP, border=20)

        self.CSbox = wx.BoxSizer(wx.VERTICAL)
        self.CSbox.Add(self.CSSbox, proportion=0, flag=wx.LEFT, border=50)
        ...
        self.vbox.Add(self.hbox, proportion=0, flag=wx.ALL|wx.EXPAND, border=0)
        ...
        self.Lcbox.Add(self.DXImportButton, proportion=0, flag=wx.ALL, border=10)
        self.Lcbox.Add(self.DXComputeButton, proportion=0, flag=wx.ALL, border=10)
        ...
        self.Bhbbox.Add(self.MSelectUserRegionButton, proportion=0, flag=wx.ALL, border=10)
        ...
        self.UPAbox.Add(self.InputPDataButton, proportion=0, flag=wx.ALL, border=10)
        self.UPAbox.Add(self.ShowPDataButton, proportion=0, flag=wx.ALL, border=10)
        self.UPAbox.Add(self.ScreenUserDataButton, proportion=0, flag=wx.ALL, border=10)
        self.UPBbox = wx.BoxSizer()
        self.UPBbox.Add(self.SelectUserRegionButton, proportion=0, flag=wx.ALL, border= 10)
        #注释部分为下拉框选择用户区域
        ...
        self.UPBbox.Add(self.UserPredictButton, proportion=0, flag=wx.ALL, border=10)
        ...
        self.PPAbox.Add(self.ImportMatrixButton, proportion=0, flag=wx.ALL, border=10)
        self.PPAbox.Add(self.InitMatrixButton, proportion=0, flag=wx.ALL, border=10)
        self.PPAbox.Add(self.AddMatrixButton, proportion=0, flag=wx.ALL, border=10)
        self.PPBbox= wx.BoxSizer()
        self.PPBbox.Add(self.HAddMatrixButton, proportion=0, flag=wx.ALL, border=10)
        self.PPBbox.Add(self.ShowMatrixButton, proportion=0, flag=wx.ALL, border=10)
        ...
        self.PPBbox.Add(self.ProblemSolButton, proportion=0, flag=wx.ALL, border=10)
        ...
        self.P3abox.Add(self.grids, proportion=1, flag=wx.EXPAND | wx.ALL, border=0)
        ...
        self.P4abox.Add(self.box_P41, proportion=1, flag=wx.EXPAND | wx.ALL, border=0)
        ...
        self.mbox.Add(self.Panel2, proportion=4, flag=wx.ALL | wx.EXPAND, border=0)
        self.mbox.Add(self.Panel3, proportion=27, flag=wx.ALL | wx.EXPAND, border=0)
        ...
        self.wbox.Add(self.tbox, proportion=9, flag=wx.ALL | wx.EXPAND, border=10)
        ...
        for i in self.Panel4.GetChildren():
            i.SetFont(f)
        f1 = wx.Font(24, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL ,False,face=u"华文新魏")
    ...
    def OnEraseBackgroundPanel(self, evt):
        ...
        print path111
        bmp = wx.Bitmap(path111+"\\"+"bgP1.jpg")
        dc.DrawBitmap(bmp, 0, 0)

    def OnEraseBackgroundPane2(self, evt):
        dc = evt.GetDC()
        if not dc:
            dc = wx.ClientDC(self)
            rect = self.GetUpdateRegion().GetBox()
        ...
        path111 = cur_file_dir()
        print path111
        bmp = wx.Bitmap(path111 + "\\" + "bgP2.jpg")
        dc.DrawBitmap(bmp, 0, 0)
    ...
    def OnPaint(self, event):
        ...
        dc.DrawRectangle(7, 592, 218, 100)
    ...
    def OnPaint2(self, event):
        ...
        dc.SetBrush(wx.Brush("#DCE2F1"))
        dc.SetPen(wx.Pen('#FFFFFF', 3, wx.SOLID))
    ...
    def CaseShow(self, evt):
        ...
        temp = u'本模块为功能模块，共具有三个功能模块：\n\n1、盲点检测功能模块 ---主要进行盲点检测，关联指标进行筛选盲点用户；\n\n' \
               ...
               u'3、网络异常分析模块 ---建立异常问题矩阵数据库，针对具体分析导入数据库进行分析，给出相应的问题分析原因及解决方案。'
        self.Set_grids(temp)
        #应用展示按钮事件，点击显示三个应用按钮
        '''if(self.Cflag == 0):
    ...
    def CaseThree(self, evt):
        ...
        self.wbox.Layout()
        temp = u'本模块为网络异常分析模块\n\n ---建立异常问题矩阵数据库，针对具体分析导入数据库进行分析，给出相应的问题分析原因及解决方案。'
        self.Set_grids(temp)
    ...
    def DXImport(self,evt):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            # 大数据分析模块中添加数据源
            self.DXFile = temp
            self.Set_grids(u"成功导入数据文件："+temp+u"！")
        dlg.Destroy()

    def DXCompute(self, evt):
        if(self.DXFile == ''):
            self.Set_grids(u"未导入数据，请重新导入！")
        else:
    ...
    def OnLeftDownUP(self, event):
        ...
        if(self.Judging(self.pos, (628,287), (872,410)) and not self.UPflag):
            path111 = cur_file_dir()
            jpg = wx.Image(path111 + "\\"+ "map\\map2.jpg",
    ...
    def MselectUserRegion(self, evt):
        ...
        # print self.Panel3.GetSize()
        path111 = cur_file_dir()
        jpg = wx.Image(path111 + "\\"+ "map\\map1.jpg",
                       wx.BITMAP_TYPE_JPEG).ConvertToBitmap()
        self.SSB = wx.StaticBitmap(self.Panel3, -1, jpg, style=wx.CENTER)
    ...
    def InitMatrix(self, evt):
        ...
        if(self.MatrixFile == ''):
            self.Set_grids(u"未导入故障矩阵初始数据，请重新导入！")
        else:
    ...
    def UpdateC1(self, evt):
        ...
        #打开指标详情文件
        path111 = cur_file_dir()
        fou = open(path111+"\\"+u"指标体系\label.txt",'r+')
...
class ProblemSolDialog(wx.Dialog):#问题诊断设置对话框
    def __init__(self, parent):
        super(ProblemSolDialog, self).__init__(parent, title = u"异常信令事件分析-问题诊断", size = (500,300))
        self.parent = parent
        ...
        self.title = wx.StaticText(self.Panel_ds1, -1, u"问题诊断设置:", style=wx.ALIGN_CENTER)
    ...
    def Set(self, evt):
        ...
        for i in range(len(self.parent.Matrix[0])):
            if (mmm.has_key(self.parent.Matrix[3][i].decode('gbk'))):
                ...
                temp += u"解决方案推荐：" + self.parent.Matrix[4][i].decode('gbk') + "\n"
